...
class MascotaCrudFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_mascota_crud, container, false)
        ...
        btnMascota.setOnClickListener{
            val intent = Intent(this@MascotaCrudFragment.requireContext(), RegistrarMascotaActivity::class.java)
